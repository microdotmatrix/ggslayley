...
window.$ = $;
  ...
  client.fetchQueryProducts({ collection_id: collectionID, sort_by: 'collection-default', limit: 5 }).then(function(products) {
    ...
    // Products ==  the array of products within the collection
		for (let i = 0; i < products.length; i++) {
			product = products[i];
			let productHTML =
          '<div class="splide__slide product" id="buy-button-'+i+'" data-layout="featured" data-product-id = "'+ product.id+'">' +
            '<div class="image-overlay-container splide__slide__container">' +
              '<img class="variant-image" src="'+product.selectedVariantImage.src+'">' +
            '</div>' +
            '<div class="product-details">' +
              ...
              '<div class="product-options">' +
                ...
                '<div class="button-container">' +
                  '<button class="btn buy-button js-prevent-cart-listener add-button" data-product-id = "'+product.id+'" data-variant-id = "'+ product.selectedVariant.attrs.id+'">Add To Cart</button>' +
        ...
        var variantAltImages = generateImages(i, product.variants);
  ...
  function generateImages(num, variants) {
    ...
    return '<div class="var-thumb">' + thumbs + '</div>';
  }
